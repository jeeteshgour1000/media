  ...
  return (
    <div className="login-background h-screen text-secondary flex lg:flex-row  sm:flex-col lg:justify-between items-center lg:px-24 ">
      ...
      <div className="lg:w-[800px] sm:w-[300px] ">
        ...
        Are you prepared to immerse yourself in a dynamic universe filled with connections, creativity, and an incredible community? Your adventure begins now as you step into the vibrant realm of Mediapage! 📸 Ignite Your Imagination 📸
        </p>
      </div>
    </div>
  );
